...
import com.janiszewski.MSSQLConnection.enums.PaymentType;
...
public class ApplicationReadyComponent {
    ...
    public void ApplicationReadyExecute() {
        if (tenantRepo.findAll().size()==0) {
            System.out.println("Starting MS SQL Connection Application initalization");
		    InitializeData();
		    CheckData();
            System.out.println("Ending MS SQL Connection Application initalization");
        }
        System.out.println("MS SQL Connection Application ready to use...");
    }
    ...
    private void InitializeContracts(){
        ...
        Contract contract2 = new Contract(Date.valueOf("2018-10-05"), Date.valueOf("2019-11-01"), Date.valueOf("2020-10-31"));
    ...
    private void InitializeBills(){
        ...
        Bill bill6 = new Bill(Date.valueOf("2020-05-01"), new Float(19256.33), BillType.PAID);
